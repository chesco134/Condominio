 ...
 */
public class ColocaNombreDesdeDialogo  implements View.OnClickListener{
    ...
    public ColocaNombreDesdeDialogo(Context context, int viewResLabel, int viewResToChange, int tipoDeEntradaDeTexto, String key, ColocaValorDesdeDialogo.FormatoDeMensaje fdm, AccionCheckBox.ActualizacionDeCampo adc) {
    ...
    public ColocaNombreDesdeDialogo(Context context, String nombreCampo, int viewResToChange, int tipoDeEntradaDeTexto,  String key, ColocaValorDesdeDialogo.FormatoDeMensaje fdm, AccionCheckBox.ActualizacionDeCampo adc) {
        this.context = context;
